...
windows|rust_lib|rust-libs/{tag}/rust.dll|libnetcode.windows.x86_64.dll
...
linux|rust_lib|rust-libs/{tag}/librust.so|libnetcode.linux.x86_64.so
...
linux-server|rust_lib|rust-libs/{tag}/librust.so|libnetcode.linux.x86_64.so
...
mac|rust_lib|rust-libs/{tag}/librust.dylib|libnetcode.macos.universal.dylib
