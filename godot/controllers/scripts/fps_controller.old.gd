...
@export var SPEED_WALKING: float = 5.0
...
var current_frame_input: FrameInput = null
...
func _physics_process(delta: float) -> void:
	...
	current_frame_input = frame_to_apply
	...
	ClientNetworkGlobals.debug.set_debug_property("Velocity", velocity)
...
func update_input() -> void:
	...
	if LowLevelNetworkHandler.is_server:
		...
		# lerp between received packets from server
		pass
